...
\centering
In this section are reported the estimation results ValNLL and MSE obtained by varying \\
...
\caption{In red: MSE between the mixture 1 pdf and its estimate PW estimate\\
...
\caption{In red: MSE between the mixture 2 pdf and its estimate PW estimate\\
In blue: ValNLL between PW estimate and the sampled points;\\
while varying the window size $h_1$ and the number of sampled points for each gaussian.}
...
\centering
\caption{In red: MSE between the mixture 3 pdf and its estimate PW estimate\\
In blue: ValNLL between PW estimate and the sampled points;\\
while varying the window size $h_1$ and the number of sampled points for each gaussian.}

...
domain $D$. If the estimator assigns non-negligible probability mass outside $D$, then the Riemann-sum
...
\begin{itemize}
    ...
    which can mitigate the apparent scaling for medium $n$.
...
the model to Parzen targets not only at samples but also in empty regions of the domain.
...
$\mathcal{O}(n^2 + n E W)$ can be amortized.
